...
def test_turboquant_roundtrip():
    from cda import TurboQuantCompressor
...
def test_sw_attention_matches_dense():
    ...
    """
    from cda import HadamardQuantCompressor, sw_attention
...
def test_hw_sw_agreement():
    ...
    from cda import HadamardQuantCompressor, hw_attention, sw_attention
