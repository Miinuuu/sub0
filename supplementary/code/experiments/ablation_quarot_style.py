...
Config: Llama-3.1-8B-Instruct, WikiText-2, max_ctx=2048, stride=64,
...
def main():
    ...
    results["fp16"] = eval_ppl(model, tokenizer, fp16_fn,
                                max_ctx=2048, stride=64, desc="FP16 baseline")
    ...
    print("\n" + "=" * 68)
    print("QuaRot-style vs CDA — Llama-3.1-8B WikiText-2:")
