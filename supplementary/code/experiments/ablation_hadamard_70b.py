...
Config: Llama-3.1-8B-Instruct, WikiText-2, max_ctx=4096, K4V2.
...
def eval_ppl(model, tokenizer, fn, max_ctx=4096, stride=64, desc=""):
    ...
    At each pos ∈ {stride, 2*stride, ..., max_ctx}: context is ids[:pos]
    and we predict ids[pos:pos+1]."""
...
def main():
    ...
    print("\n" + "=" * 60)
    print("Hadamard ablation summary — Llama-3.1-70B WikiText-2:")
